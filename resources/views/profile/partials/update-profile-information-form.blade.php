        ...
        <div class="tw-flex tw-items-center tw-gap-4">
            ...
            @if (session('status') === 'profile-updated')
                <p
                    ...
                    class="tw-text-sm tw-text-gray-600 tw-dark:tw-text-gray-400"
                >{{ __('Saved.') }}</p>
            @endif
        </div>
    </form>
