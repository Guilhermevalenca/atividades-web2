<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="tw-flex tw-items-center tw-justify-end tw-mt-4">
            <a class="tw-underline tw-text-sm tw-text-gray-600 tw-dark:tw-text-gray-400 tw-hover:tw-text-gray-900 tw-dark:tw-hover:text-gray-100 tw-rounded-md tw-focus:tw-outline-none tw-focus:tw-ring-2 tw-focus:tw-ring-offset-2 tw-focus:tw-ring-indigo-500 tw-dark:tw-focus:tw-ring-offset-gray-800" href="{{ route('login') }}">
