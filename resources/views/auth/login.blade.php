    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="tw-block tw-mt-4">
            <label for="remember_me" class="tw-inline-flex tw-items-center">
                <input id="remember_me" type="checkbox" class="tw-rounded tw-dark:tw-bg-gray-900 tw-border-gray-300 tw-dark:tw-border-gray-700 tw-text-indigo-600 tw-shadow-sm tw-focus:tw-ring-indigo-500 tw-dark:tw-focus:tw-ring-indigo-600 tw-dark:tw-focus:tw-ring-offset-gray-800" name="remember">
                <span class="tw-ms-2 tw-text-sm tw-text-gray-600 tw-dark:tw-text-gray-400">{{ __('Remember me') }}</span>
            </label>
        </div>

        <div class="tw-flex tw-items-center tw-justify-end tw-mt-4">
            @if (Route::has('password.request'))
                <a class="tw-underline tw-text-sm tw-text-gray-600 tw-dark:tw-text-gray-400 tw-hover:tw-text-gray-900 tw-dark:tw-hover:tw-text-gray-100 tw-rounded-md tw-focus:tw-outline-none tw-focus:tw-ring-2 tw-focus:tw-ring-offset-2 tw-focus:tw-ring-indigo-500 tw-dark:tw-focus:tw-ring-offset-gray-800" href="{{ route('password.request') }}">
